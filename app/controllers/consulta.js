...
module.exports.identificarSuspeitos = function(application, req, res){
	const params = req.query;
	console.log(params)
	...
	consultaModel.identificarSuspeitos(params, req, res);
}
...
module.exports.consultaPersonalizadaIs = function(application, req, res){
    const dados = req.body;
	const params = req.params;
	console.log(params);

    var connection = application.config.dbConnection;
	var consultaPersonalizadaModel = new application.app.models.consultaPersonalizadaIsDAO(connection);

	consultaPersonalizadaModel.consultaPersonalizadaIs(dados, req, res);
